 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new H(t,e.slice(1),s).parts}if("@"===n)return[new j(t,e.slice(1),i.eventContext)];if("?"===n)return[new R(t,e.slice(1),s)];return new V(t,e,s).parts}handleTextExpression(t){return new z(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
